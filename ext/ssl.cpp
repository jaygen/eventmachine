...
SslContext_t::SslContext_t (bool is_server, const string &privkeyfile, const string &certchainfile, const string &cipherlist):
	pCtx (NULL),
	PrivateKey (NULL),
	Certificate (NULL)
{
...
SslBox_t::SslBox_t (bool is_server, const string &privkeyfile, const string &certchainfile, bool verify_peer, const unsigned long binding, const string &cipherlist):
	bIsServer (is_server),
	...
	pbioWrite (NULL)
{
	...
	Context = new SslContext_t (bIsServer, privkeyfile, certchainfile, cipherlist);
	assert (Context);
